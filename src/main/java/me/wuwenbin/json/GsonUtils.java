...
/**
 * 此类是根据Google的Gson而定制的Json相关工具类方法，此包由google自行研发而来。
 * Gson的应用主要为toJson与fromJson两个转换函数，无依赖，不需要例外额外的jar。
 * Created By wuwenbin on 2016/8/28
 * @author wuwenbin
 * @since 1.0
 *
 */
public class GsonUtils {
    ...
    public static String toJson(Object target, Type targetType, boolean isSerializeNulls, Double version, String datePattern, boolean excludesFieldsWithoutExpose) {
        ...
        try {
            ...
            log.warning("目标对象 " + target.getClass().getName() + " 转换 JSON 字符串时，发生异常！");
            log.throwing("GsonUtil", "toJson(Object, Type, boolean, Double, String, boolean)", ex);
    ...
    public static <T> T fromJson(String json, TypeToken<T> token, String datePattern) {
        ...
        try {
            ...
            log.warning(json + " 无法转换为 " + token.getRawType().getName() + " 对象!");
            log.throwing("GsonUtil", "fromJson(String, TypeToken<T>, String)", ex);
            return null;
        }
    }
    ...
    public static <T> T fromJson(String json, Class<T> clazz, String datePattern) {
        ...
        try {
            ...
            log.warning(json + " 无法转换为 " + clazz.getName() + " 对象!");
            log.throwing("GsonUtil", "fromJson(String, Class<T>, String)", ex);
            return null;
        }
    }
